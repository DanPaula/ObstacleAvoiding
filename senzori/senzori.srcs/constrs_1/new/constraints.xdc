...
set_property PACKAGE_PIN J2 [get_ports {trigger1}]					
	...
	set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets trigger1]
#Sch name = JA2
...
set_property PACKAGE_PIN J1 [get_ports {trigger2}]					
	...
	set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets trigger2]
#Sch name = JA2
...
set_property PACKAGE_PIN H1 [get_ports {trigger3}]					
	...
	set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets trigger3]
#Sch name = JA2
...
#set_property PACKAGE_PIN A14 [get_ports {trigger3}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {trigger3}]
	#set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets trigger3]
#Sch name = JA2
#set_property PACKAGE_PIN A16 [get_ports {echo3}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {echo3}]
