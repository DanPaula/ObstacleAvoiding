...
HD_PWD='C:/Users/paula/Desktop/SEM1/SSC/proiect/Obstacle/ObstacleAvoidance/ObstacleAvoidance.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log CarMain.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source CarMain.tcl -notrace
