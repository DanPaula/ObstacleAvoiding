...
HD_PWD='C:/Users/paula/Desktop/SEM1/SSC/proiect/Obstacle/ObstacleAvoidance/ObstacleAvoidance.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CarMain.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CarMain.tcl
