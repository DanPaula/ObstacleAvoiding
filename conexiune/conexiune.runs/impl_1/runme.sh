...
HD_PWD='C:/Users/paula/Desktop/SEM1/SSC/proiect/conexiune/conexiune.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log BasysToArduino.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source BasysToArduino.tcl -notrace
