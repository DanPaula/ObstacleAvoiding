...
HD_PWD='C:/Users/paula/Desktop/SEM1/SSC/proiect/conexiune/conexiune.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BasysToArduino.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BasysToArduino.tcl
